...
# Portal
PORTAL_RADIUS = 0.5
PORTAL_COLOR = formatColor(4.0/255.0, 160.0/255.0, 1)
    ...
    def drawPortals(self, portals):
        ...
        for portal in portals:
            ...
            door = circle((screen_x, screen_y),
                          ...
                          outlineColor=formatColor((randrange(255))/255.0, (randrange(255))/255.0, (randrange(255))/255.0),
                          fillColor=formatColor((randrange(255))/255.0, (randrange(255))/255.0, (randrange(255))/255.0),
                          width=1)
