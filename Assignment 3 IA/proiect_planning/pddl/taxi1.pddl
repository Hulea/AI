...
;;;Layoutul pentru a doua rulare din python
...
(define (problem crazy_taxi)
   ...
   (:objects
    ...
    (:init
        ...
        (afara nicu)
        (locatie_client nicu strada_doi)


        (locatie_taxi crazy_taxi intersectia_3)
    ...
    (:goal
      (and
        (afara ion)
        (locatie_client ion intersectia_7)
        (afara nicu)
        (locatie_client nicu strada_opt)
       ))
)
